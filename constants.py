...
def is_image_generation_model(model_name):
    ...
    return model_name == "gemini-2.5-flash-image-preview"
...
🎨 *Генерировать изображения:* Выберите модель "2.5 Flash IMG🎨" и просто опишите, что хотите увидеть! Могу создавать изображения по тексту, редактировать загруженные фото и делать серию изменений в диалоге.
...
HELP_TEXT_TEMPLATE = (
    ...
    "*Генерация изображений (модель 2.5 Flash IMG🎨):*\n"
