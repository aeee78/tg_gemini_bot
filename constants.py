...
COMMAND_LIST = [
    ...
    BotCommand(
        "/generate", "🖼️ Сгенерировать изображение (напр. /generate кот)"
    ),
...
HELP_TEXT_TEMPLATE = (
    ...
    "- `/generate <запрос>`: Создает изображение по вашему описанию (например, `/generate space dog`). Этот запрос не влияет на основной чат. Лучше делать запросы на английском\n\n"
